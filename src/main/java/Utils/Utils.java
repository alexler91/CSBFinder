                ...
                while (line != null) {
                    if (line.startsWith(">")) {
                        ...
                        if (split_line.length > 1) {
                            ...
                            List<Gene> geneList = genomeToGeneListMap.get(curr_genome_name);
                            geneList = geneList == null ? new ArrayList<>() : geneList;
                            geneList.add(gene);
                            genomeToGeneListMap.put(curr_genome_name, geneList);
                        }
                    }
