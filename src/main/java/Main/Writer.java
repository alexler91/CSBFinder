...
public class Writer {
    ...
    private String instances_file_name;
    private boolean include_families;
    ...
    public Writer(int max_error, int max_deletion, int max_insertion, boolean debug, String catalog_file_name,
        ...
        this.instances_file_name = instances_file_name;
        this.include_families = include_families;
    ...
    public void setOutput_file_type(OutputType output_file_type) {
        this.output_file_type = output_file_type;
        this.init(catalog_file_name, instances_file_name, include_families);
    }
}
